...
/// Import the module with all the constants.
pub mod consts;

/// The runtime version.
#[runtime_version]
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("orehub-runtime"),
    impl_name: create_runtime_str!("orehub-runtime"),
    authoring_version: 1,
    spec_version: 0,
    impl_version: 1,
...
impl frame_system::Config for Runtime {
    ...
    type SS58Prefix = frame::traits::ConstU16<{ consts::SS58_PREFIX }>;
