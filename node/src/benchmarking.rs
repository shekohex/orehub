...
use frame::deps::{
    frame_system,
    sp_core::{self, Encode, Pair},
};
use orehub_runtime as runtime;
use runtime::interface::{AccountId, Balance, BalancesCall, SystemCall};
use sc_cli::Result;
...
pub fn create_benchmark_extrinsic(
    ...
    runtime::UncheckedExtrinsic::new_signed(
        ...
        runtime::interface::Signature::Ed25519(signature),
        extra,
    )
}
